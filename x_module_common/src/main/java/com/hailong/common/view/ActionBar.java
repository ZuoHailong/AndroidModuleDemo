package com.hailong.common.view;
...
import com.hailong.common.utils.PxUtils;
...
public class ActionBar extends RelativeLayout {
     ...
     * 字体颜色
     */
    private int leftTextColor = R.color.x_module_common_colorWhite;
    private int centerTextColor = R.color.x_module_common_colorWhite;
    private int rightTextColor = R.color.x_module_common_colorWhite;
    /**
     * 字体大小
     */
    ...
    public void setLeftGone() {
        this.llLeft.setVisibility(INVISIBLE);
    }
    ...
    private void initView(Context context) {
        rootView = View.inflate(context, R.layout.x_module_common_action_bar, this);
    ...
    public void showBackImg(boolean show) {
        if (show) {
            setLeftIcon(R.mipmap.x_module_common_ic_back_white, new OnClickListener() {
                @Override
